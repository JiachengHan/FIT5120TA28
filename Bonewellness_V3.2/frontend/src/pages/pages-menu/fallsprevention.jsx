          ...
          <div className="row align-items-center">
            ...
            <div className="col-xl-5 col-lg-6 ms-auto" data-aos="fade-left">
              <p className="m0 fs-20 lh-lg text-center text-lg-start md-pt-20">
                As elderly people and particularly those with osteoporosis have
                high risk of fall-related fractures, raising awareness about
                falls prevention strategies is crucial because it empowers
                elderly individuals and those with osteoporosis to take
                proactive steps in safeguarding their health and independence.
              </p>
            </div>
          </div>
        </div>
