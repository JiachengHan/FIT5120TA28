...
const RiskofDeath = () => {
  ...
  useEffect(() => {
    ...
    svgLineChart
      ...
      .style("font-weight", "bold")
      .text("Deaths To Falls Ratio By Age Group (2017-2019)");
    const tooltip = d3
      .select("body")
      .append("div")
      .attr("class", "tooltip")
    ...
    <div>
      ...
      <div>
        ...
        <p className="fs-20">
          ...
          age. From 1% deaths to falls ratio for age group 65-69 to around 10%
          for those aged 95+ (i.e. ten times increased risk of death). The
          latter necessitates that the elderly should take great care in
          reducing their risk of falls to avoid such unfortunate scenario
        </p>
      </div>
    </div>
  );
