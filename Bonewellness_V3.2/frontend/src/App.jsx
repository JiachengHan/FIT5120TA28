...
import Informations from "./pages/pages-menu/informations";
...
import PreventionPage from "./pages/pages-menu/preventionpage";
import Hospital from "./pages/portfolio/HospitalPage";
import FallsPrevention from "./pages/pages-menu/fallsprevention";
import RiskAssessment from "./pages/contact/riskassessment";
function App() {
  useEffect(() => {
    Aos.init({
      duration: 1200,
    ...
    <div className="main-page-wrapper">
      <Routes>
        <Route path="/">
          ...
          <Route
            path="pages-menu/fallsprevention"
            element={<FallsPrevention />}
          />
          <Route path="portfolio/HospitalPage" element={<Hospital />} />
          <Route path="contact/riskassessment" element={<RiskAssessment />} />
          ...
          <Route
            path="pages-menu/preventionpage"
          ...
          <Route path="pages-menu/informations" element={<Informations />} />
