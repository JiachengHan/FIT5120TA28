        ...
        <ul className="navbar-nav" style={{ textAlign: "center" }}>
          ...
          <li className="nav-item  dropdown">
            <Link
              ...
              className={`nav-link ${
                isActive("/pages-menu/informations") ? "active-menu" : ""
              }`}
            >
              Data Insights
            </Link>
          ...
          <li className="nav-item dropdown">
            <Link
              ...
              className={`nav-link ${
                isActive("/pages-menu/preventionpage") ? "active-menu" : ""
              }`}
            >
              Prevention
            </Link>
          ...
          <li className="nav-item dropdown">
            <Link
              ...
              className={`nav-link ${
                isActive("/contact/riskassessment") ? "active-menu" : ""
              }`}
            >
              Risk Model
            </Link>
          ...
          <li className="nav-item dropdown">
            <Link
              ...
              className={`nav-link ${
                isActive("/portfolio/HospitalPage") ? "active-menu" : ""
              }`}
            >
              Hospital
            </Link>
          ...
          <li className="nav-item dropdown">
            <Link
              ...
              className={`nav-link ${
                isActive("/pages-menu/fallsprevention") ? "active-menu" : ""
              }`}
            >
              Falls Among Elderly
            </Link>
