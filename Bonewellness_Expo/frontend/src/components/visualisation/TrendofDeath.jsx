  ...
  return (
    <div>
      ...
      <div>
        ...
        <p className="fs-20">
          Falls among elderly population is a common issue worldwide, and in
          Australia, it is considered the leading cause of injury
          hospitalisation and death (AIHW, 2023). The AIHW data on falls among
          elderly Australians, revealed a concerning increasing trend of deaths
          due to falls for older Australians 65 and above.
        </p>
      </div>
    </div>
  );
