        ...
        <div className="row">
          ...
          >
            ...
            <p className="text-lg tx-dark mt-45 mb-50 lg-mt-30 lg-mb-40">
              We are targeting elderly Australians who are at an increased risk
              for osteoporosis, and wants to maintain their physical
              independence and be proactive about their bones health
            </p>
            {/* <form
            ...
            >
              ...
              <input
                ...
                value={postcode}
              />
              <button className="fw-500 text-white " type="submit">
                Search
              </button>
            </form> */}
            ...
            <div>
              <div className="approval-info d-inline-flex align-items-center mt-50 lg-mt-80">
