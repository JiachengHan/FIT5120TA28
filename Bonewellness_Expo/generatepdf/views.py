...
class GeneratePDF(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        subtitle4 = data['result'][:35]
        subtitle5 = data['result'][36:-22]
        subtitle6 = data['result'][-21:]
        response = HttpResponse(content_type='application/pdf')
        response['Content-Disposition'] = 'attachment; filename="report.pdf"'
        chartTitle = "The following graph shows the weight of the input features."
        disclaimer1 = "Disclaimer"
        disclaimer2 = "This tool should not be consider as a medical diagnosis."
        ...
        disclaimer7 = "Disclaminer: This is not a medical report."
        ...
        p.drawCentredString(300, 780, title_line1)
        
        p.drawCentredString(300, 750, title_line2)

        p.setFont("Times-Bold", 14) 
        p.drawCentredString(290, 720, disclaimer7) 
        ...
        p.drawCentredString(290, 635, subtitle2) 
        p.setFillColorRGB(0, 0, 0) 
        p.setFont("Times-Bold", 16) 
        p.drawCentredString(290, 605, subtitle3) 
        p.setFont("Times-Roman", 16) 
        p.drawCentredString(290, 590, subtitle4) 
        if subtitle5 == "HIGH":
            p.setFillColor("orange")  
        else:
            p.setFillColor("blue") 
        p.setFont("Times-Bold", 30) 
        p.drawCentredString(290, 545, subtitle5) 
        p.setFillColorRGB(0, 0, 0) 
        p.setFont("Times-Roman", 16) 
        p.drawCentredString(290, 510, subtitle6) 
        
        p.line(30, 480, 550, 480) 

        p.setFont("Times-Bold", 14) 
        p.drawCentredString(290, 460, textTitle) 

        text = p.beginText(40, 440) 
        ...
        p.line(30, 340, 550, 340) 

        # p.setFont("Times-Bold", 16)
        # p.drawCentredString(300, 320, chartTitle)
        ...
        p.setFont("Times-Bold", 16)
        p.drawCentredString(300, 315, disclaimer1)
        p.setFont("Times-Roman", 14)
        p.drawCentredString(300, 300, disclaimer2)
        p.setFont("Times-Roman", 14)
        p.drawCentredString(300, 285, disclaimer3)
        p.setFont("Times-Roman", 14)
        p.drawCentredString(300, 270, disclaimer4)
        p.setFont("Times-Roman", 14)
        p.drawCentredString(300, 255, disclaimer5)
        p.setFont("Times-Roman", 14)
        p.drawCentredString(300, 240, disclaimer6)
